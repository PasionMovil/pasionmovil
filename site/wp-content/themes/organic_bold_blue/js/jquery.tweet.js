(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      ...
      auto_join_text_reply: "Cotnesté a",   // [string]   auto tense for replies: "i replied to" @someone "with"
      auto_join_text_url: "Buscaba en", // [string]   auto tense for urls: "i was looking at" http:...
    ...
    function relative_time(time_value) {
      ...
      return 'Hace ' + pluralize("día", parseInt(delta / 86400)) + '';
      }
    }
